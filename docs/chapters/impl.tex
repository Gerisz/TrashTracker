...
\begin{figure}[H]
	...
	\subcaptionbox{Az adatbázis osztályai forráskód oldalon}{
		\includegraphics[width=0.85\textwidth]{database_cs}}
	\vspace{5pt}
	\subcaptionbox{Az adatbázis sémája SQL oldalon}{
		\includegraphics[width=0.85\linewidth]{database_sql}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{component}
...
\lstset{caption={Egy metódus dokumentációjára példa C\# nyelven}, label=src:csharp}
