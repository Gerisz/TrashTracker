...
\section{A weboldal funkciói vendégként}

Egy vendég felhasználó számára hat funkció érhető el a weboldalon:
\begin{itemize}
...
\section{Futás közbeni üzenetek}

A program egy weboldal, melynek meglátogatásához szükség van egy Chromium alapú (legfrissebb verziójú) böngészőre, ezen kívül nincsen szükség más szoftver telepítésére/elindítására.
